...
>For the abyssal analytic, the modern episteme is not understood as a product of abstract or ‘reductionist’ thinking which today needs to be ‘grounded’, ‘adjusted’ or ‘corrected’. The critique of modernity is not that it fails to understand complexity or contingency or relation; that it commits what is often called ‘epistemological violence’. Modernist understandings are not merely a problem of thought or of approach, but a problem ingrained within the materiality of the world. Modernist understandings are understood to be integral to the real material and ongoing reproduction of structural inequity, dispossession, coloniality and racial capitalism.[^4]
...
.ve-media https://iiif.europeana.eu/presentation/463/item_NNQWV344NLKLOVAQT4PXJSKD57DUYSYJ/manifest width=80% center
